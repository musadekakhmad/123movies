        ...
        <section className="bg-gray-800 rounded-2xl p-8 shadow-2xl transform hover:scale-105 transition-transform duration-300">
          ...
          <div className="flex flex-col items-center justify-center text-center mb-8">
            <h1 className="text-3xl md:text-4xl font-extrabold drop-shadow-lg mb-2 text-blue-500">
              123Movies: Watch Free Movies and TV Series
            </h1>
          ...
          <p className="text-gray-300 text-justify leading-relaxed">
            We are not resting on our laurels. Our team is continuously exploring new technologies and innovative ideas to enhance the 123Movies experience. Our future plans include implementing AI-powered features for more personalized recommendations, integrating with social media for seamless sharing, and an ever-growing library of exclusive content. We also plan to expand our language support, making 123Movies accessible to an even wider global audience.
          </p>
          <p className="mt-4 text-gray-300 text-justify leading-relaxed">
            Every step we take is driven by our dedication to providing the best entertainment experience for free. We appreciate your support and invite you to follow us on this thrilling journey. 123Movies is a testament to the power of community and a shared passion for cinema. Thank you for being a part of our extended family.
          </p>

          {/* Our Team Section - Added */}
          <h2 className="text-3xl font-bold text-white mb-6 mt-8">Our Team</h2>
          <p className="text-gray-300 text-justify leading-relaxed">
            Behind the scenes at 123Movies, there is a passionate team of individuals working tirelessly to bring our vision to life. From the developers who optimize your streaming experience to the content curators who find hidden gems, every team member is committed to excellence. We are a group of dedicated film and TV series fans who are devoted to sharing our love for cinema with the world.
          </p>
          <p className="mt-4 text-gray-300 text-justify leading-relaxed">
